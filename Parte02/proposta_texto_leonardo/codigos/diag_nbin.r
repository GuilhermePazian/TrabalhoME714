...
a <- max(td)
b <- min(td)
plot(td,xlab="Índice", ylab="R.C.D.",
ylim=c(b-1,a+1), pch=16,cex=1,cex.axis=1,cex.lab=1, main = "Gráfico 1")
abline(2,0,lty=2)
abline(-2,0,lty=2)
abline(0,0,lty=2)
#
plot(fitted(fit.model),td,xlab="Valor Ajustado", 
ylab="R.C.D.", ylim=c(b-1,a+1), pch=16,cex=1,cex.axis=1,cex.lab=1, main = "Gráfico 2")
#
abline(2,0,lty=2)
abline(-2,0,lty=2)
abline(0,0,lty=2)
...
ylab="Variável z", pch=16,cex=1,cex.axis=1,cex.lab=1, main = "Gráfico 3")
abline(0,1)
#------------------------------------------------------------#
}
