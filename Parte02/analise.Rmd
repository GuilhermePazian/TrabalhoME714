...
```{r fig.cap = fig1, fig.pos="H", fig.align='center', fig.asp=0.75, echo=FALSE}
...
```{r fig.cap = fig2, fig.pos="H", fig.align='center', fig.asp=0.75,echo=FALSE}
...
```{r fig.cap = fig3, fig.pos="H", fig.align='center', fig.asp=0.75, echo=FALSE}
...
```{r fig.cap = fig4, fig.pos="H", fig.align='center', fig.asp=0.75,echo=FALSE}
...
```{r fig.cap = fig5, fig.pos="H", fig.align='center',fig.asp=0.75,echo=FALSE}
...
```{r fig.cap = fig6, fig.pos="H", fig.align='center',fig.asp=0.75,echo=FALSE}
...
fig8 <- "Este gráfico compara os quantís do RCD para o modelo reduzido (ver Paula, 2013). Note que muitos dos resíduos estão fora da banda de confiança e muito distantes da linha de referência (tracejada). Com isso, pode-se comcluir que o ajuste não é razoável para os dados em questão."
...
Os gráficos para verificar a qualidade do ajuste binomial negativo para o modelo completo foram obtidos e avaliados como mostrado abaixo.
