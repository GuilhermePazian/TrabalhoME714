...
fit.model_p <- glm(dados$`Nº de infecções` ~ dados$`Hab. de nadar` + dados$Local + dados$`Faixa etária` + dados$`Hab. de nadar`:dados$`Faixa etária` + dados$Local:dados$`Faixa etária`, family=poisson(link="log"),data = dados)
...
Depois de vários testes feitos, a seleção de variáveis para o modelo final encontrado levou em consideração algumas fatores principais como hábito de nadar, local onde costuma nadar e faixa etária e suas respectivas interações de terceira ordem: interações entre hábito, faixa etária,  e local onde costuma nadar. Tal modelo é representado por
...
onde as interpretações dos parâmetros estão na seção Anexos. Abaixo seguem alguns gráficos de resíduo.
...
Concluí-se, também que os fatores que mais impactam no alto número de infeções de ouvidos são (de acordo com o modelo final de Poisson): hábito de nadar ocasianalmente, na piscina, para aqueles com idade entre 15 e 19 anos.
...
## Tabelas Resumo do Ajuste do Modelo Completo
...
\begin{tabular}{rrrrrrr}
 ...
 Intercepto & 0,0112 & 0,1353 & -0,2540 & 0,2764 & 0,0828 & 0,9340 \\
  Hábito (Ocasional) & 0,4519 & 0,1373 & 0,1828 & 0,7210 & 3,2916 & 0,0010 \\
  Local  (Piscina)  & 0,3683 & 0,1365 & 0,1008 & 0,6359 & 2,6982 & 0,0070 \\
  Faixa etária 20-24 & -0,8439 & 0,2951 & -1,4222 & -0,2655 & -2,8595 & 0,0042 \\
  Faixa etária 25-29 & -0,7522 & 0,2836 & -1,3081 & -0,1962 & -2,6519 & 0,0080 \\
  Hábito (Ocasional):Faixa etária 20-24 & 0,1424 & 0,2571 & -0,3616 & 0,6463 & 0,5537 & 0,5798 \\
  Hábito (Ocasional):Faixa etária 25-29 & 0,6660 & 0,2913 & 0,0950 & 1,2370 & 2,2862 & 0,0222 \\
  Local (Piscina):Faixa etária 20-24 & 0,5717 & 0,2873 & 0,0086 & 1,1348 & 1,9900 & 0,0466 \\
  Local (Piscina):Faixa etária 25-29 & 0,1893 & 0,2594 & -0,3190 & 0,6977 & 0,7299 & 0,4654 \\
   
\end{tabular}
\captionof{table}{Tabela resumo para o modelo de Poisson. Note que Hábito é o hábito que costuma nadar, para esta variável a referência é considerada como frequente; Local é o local onde se costuma nadar, cuja referência é considerada praia; Faixa etária, em que a referência é considerada 15-19; e as interações entre essas variáveis como Hábito e faixa etária, e local e faixa etária.}
\end{table}
