...
```{r sourcing_analysis,echo=FALSE,cache=TRUE}
...
Ao considerar a tabela \ref{table:model2}, pode-se perceber alta significância de vários parâmetros, ao contrário do modelo 2. 
