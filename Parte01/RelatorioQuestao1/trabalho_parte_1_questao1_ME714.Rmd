...
$\bar{S}_{Allbond} = n_{10}\theta_{10} + n_{11}\theta_{11} + n_{12}\theta_{12} + n_{13}\theta_{13} + n_{14}\theta_{14}$  
$\bar{S}_{Optibond} = n_{20}\theta_{20} + n_{21}\theta_{21} + n_{22}\theta_{22} + n_{23}\theta_{23} + n_{24}\theta_{24}$  
$\bar{S}_{Scotchbond} = n_{30}\theta_{30} + n_{31}\theta_{31} + n_{32}\theta_{32} + n_{33}\theta_{33} + n_{34}\theta_{34}$
