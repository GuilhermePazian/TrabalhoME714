...
Portanto, para o material Allbond obteve-se $$soma_{011}=\frac{soma_{01}+soma_{11}}{72}=\frac{9+18}{72}=\frac{27}{72}$$ `r medias_A`. 
Já para Optibond, $$soma_{012}=\frac{soma_{02}+soma_{12}}{72}=\frac{26+34}{72}=\frac{60}{72}=$$ `r medias_O`. 
Para Scotchbond, $$soma_{013}=\frac{soma_{03}+soma_{13}}{72}=\frac{9+17}{72}=\frac{26}{72}$$ `r medias_S`

Logo, medindo esses resultados em porcentagem, temos que para Allbond `r medias_A`% das classificações estão alocadas entre 0 e 1. Utilizando mesmo raciocínio, para Optibond `r medias_O`% e, Scotchbond `r medias_S`%. 
