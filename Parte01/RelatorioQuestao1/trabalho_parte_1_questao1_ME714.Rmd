...
seja i = 1,2,3
$$N_{i}=(N_{i0},N_{i1},N_{i2},N_{i3},)^{'}\sim multinomial(n_{i.},\mathbf{\theta}_{i})$$

$\mathbf{{\theta_{i}}}=(\theta_{i0},\theta_{i1},\theta_{i2},\theta_{i3})^{'}$ , $\theta_{ij} \in  (0,1)$ e $\theta_{i4} = 1- \sum_{j=0}^{3} \theta_{ij}$
